        ...
        return {
          ...
          menu: (
            <SourceMenu
              ...
              onOpenInNewWindow={() => window.webAgentAPI.openUrl(`craftagents://sources/source/${source.config.slug}?window=focused`)}
              onShowInFinder={() => window.webAgentAPI.showInFolder(source.folderPath)}
