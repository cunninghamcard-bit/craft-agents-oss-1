...
export function SidebarMenu({
  ...
  if (type === 'newSession') {
    return (
      <MenuItem onClick={() => window.webAgentAPI.openUrl('craftagents://action/new-session?window=focused')}>
  ...
  if (type === 'sources') {
    ...
    return (
      <>
        ...
        <Separator />
        <MenuItem onClick={() => window.webAgentAPI.openUrl(getDocUrl(docFeature))}>
  ...
  if (type === 'automations') {
    return (
      <>
        ...
        <Separator />
        <MenuItem onClick={() => window.webAgentAPI.openUrl(getDocUrl('automations'))}>
          <ExternalLink className="h-3.5 w-3.5" />
