/**
 * ShikiCodeViewer - WebUI wrapper for the portable ShikiCodeViewer
 *
 * This thin wrapper imports the portable component from @craft-agent/ui
 * and connects it to WebUI's ThemeContext and preset themes.
 */
 ...
 * Connected to WebUI's theme context and preset themes.
 */
