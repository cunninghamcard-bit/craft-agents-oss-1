/**
 * ShikiDiffViewer - WebUI wrapper for the portable ShikiDiffViewer
 *
 * Connects the base component to WebUI's ThemeContext, passing the
 ...
 * Connected to WebUI's theme context. Passes the app's Shiki theme
