...
Extracted from `@anthropic-ai/claude-agent-sdk` v0.1.62
Date: 2025-12-19
...
Current branch: ghalmos/extract-system-prompt
...
Recent commits:
8ad312f approaching feature parity
403ca4c Merge pull request #53 from lukilabs/obalint/electron_app
17bd7e6 packages simplification
44cdeaa TUI runs well
3b20a7a docs: update README.md files with monorepo structure and new features